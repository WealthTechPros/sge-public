...
No licence is granted to any person or organisation that is not a Subscriber.
This repository is publicly visible so that Subscribers can install the
Software directly; viewing or forking the source on GitHub is permitted by
GitHub's Terms of Service, but neither grants any right to use, copy, modify,
or distribute the Software.

## 3. Restrictions

Subscribers must not redistribute the Software or derivative works,
...
FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT. IN NO EVENT SHALL WTP
