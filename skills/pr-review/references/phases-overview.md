...
| 5 | Aggregate & report | Merge findings, verify blockers, build the `sge-verdict` block | sonnet |
...
| 7 | CI to green (optional) | If checks are red, drive them green via the `/sge:pr-fix` loop before passing | sonnet |
