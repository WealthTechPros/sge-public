...
```
SGD alignment — <repo> @ <audited SHA>
  C1  Vision exists ............. ✅
...
```json
{
  ...
  "checks": [
    ...
    { "id": "C14", "layer": "process", "applicable": true, "pass": 46, "fail": 4, "overrides": 6, "signal": "46/50 merged PRs test-evidenced (6 via SGD-Override: TDD), 4 test-free" },
  ...
  "agentAttribution": [
    { "agentId": "agent-01JQ8Z7K9X4M2N6P0R3T5V7W9B", "commits": 12, "model": "claude-sonnet-4-6", "skill": "sgd-implement", "issue": 283 },  // model ID as of 2026-06-30
...
`docs/sgd/drift-trend.jsonl` instead of the target repo's (issue #1041):
...
```bash
mkdir -p docs/sgd
trend=docs/sgd/drift-trend.jsonl
