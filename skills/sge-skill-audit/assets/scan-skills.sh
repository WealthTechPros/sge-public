...
# ---------------------------------------------------------------------------------------
# Single source of truth for the structural half of /sge:sge-skill-audit (and the
# skill-quality dimension sge-align delegates here). Extracted from SKILL.md prose per
...
#        (mirrors sge-align's docs/sge/drift-trend.jsonl convention).
set -euo pipefail
